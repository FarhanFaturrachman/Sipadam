...
object WordGeneratorPencarian {
    ...
    fun generate(context: Context, laporan: LaporanPencarianPenyelamatan): File {
        // Buka template Word dari assets (pastikan ada file "BA PENCARIAN.docx" di folder assets)
        val templateStream = context.assets.open("BA EVAKUASI.docx")
        ...
        val replacements = mapOf(
            ...
            "{kronologi}" to laporan.kronologi,
            "{instansi}" to laporan.instansi,
        ...
        val fileName = "LAPORAN_PENYELAMATAN_${safeKegiatan}_${safeHari}_${safeTanggal}.docx"
