...
class PenangananBinatangAdapter(
    private var laporanList: List<LaporanPenangananBinatang>,
    private val onDetailClick: (LaporanPenangananBinatang) -> Unit,
    private val onEditClick: (LaporanPenangananBinatang) -> Unit,
    private val onDeleteClick: (LaporanPenangananBinatang) -> Unit,
    private val onShareClick: (LaporanPenangananBinatang) -> Unit
) : RecyclerView.Adapter<PenangananBinatangAdapter.ViewHolder>() {

    fun updateData(newData: List<LaporanPenangananBinatang>) {
        laporanList = newData
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_laporan, parent, false) // ✅ pakai XML baru
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvObjek.text = laporan.jenisKegiatan     // misal kamu pakai jenisKegiatan sbg objek
        ...
        holder.menuMore.setOnClickListener {
            ...
            popup.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    R.id.menu_edit -> {
                        onEditClick(laporan); true
                    }
                    R.id.menu_delete -> {
                        onDeleteClick(laporan); true
                    }
                    R.id.menu_share -> {
                        onShareClick(laporan); true
                    }
                    else -> false
                }
            }
